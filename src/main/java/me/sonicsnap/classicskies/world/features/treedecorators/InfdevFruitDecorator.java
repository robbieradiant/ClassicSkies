package me.sonicsnap.classicskies.world.features.treedecorators;
...
public class InfdevFruitDecorator extends CocoaDecorator {
	public static final InfdevFruitDecorator INSTANCE = new InfdevFruitDecorator();
	public static com.mojang.serialization.Codec<InfdevFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("infdev_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public InfdevFruitDecorator() {
		super(0.2f);
	}
