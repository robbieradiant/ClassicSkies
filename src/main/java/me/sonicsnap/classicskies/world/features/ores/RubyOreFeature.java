...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("classicskies:ruby_ore", FEATURE,
				new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, ClassicskiesModBlocks.RUBY_ORE.get().defaultBlockState(), 6));
		PLACED_FEATURE = PlacementUtils.register("classicskies:ruby_ore", CONFIGURED_FEATURE,
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("classicskies:ruby_ore_match"), CUSTOM_MATCH);
		}
