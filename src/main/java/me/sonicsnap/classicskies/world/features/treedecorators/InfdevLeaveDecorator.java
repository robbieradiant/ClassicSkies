...
public class InfdevLeaveDecorator extends LeaveVineDecorator {
	public static final InfdevLeaveDecorator INSTANCE = new InfdevLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("infdev_tree_leave_decorator");
