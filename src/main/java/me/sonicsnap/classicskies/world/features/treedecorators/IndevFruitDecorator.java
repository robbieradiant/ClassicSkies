...
public class IndevFruitDecorator extends CocoaDecorator {
	public static final IndevFruitDecorator INSTANCE = new IndevFruitDecorator();
	public static com.mojang.serialization.Codec<IndevFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("indev_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public IndevFruitDecorator() {
		super(0.2f);
	}
