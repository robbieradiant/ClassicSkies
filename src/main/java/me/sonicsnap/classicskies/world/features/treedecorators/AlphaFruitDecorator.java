...
public class AlphaFruitDecorator extends CocoaDecorator {
	public static final AlphaFruitDecorator INSTANCE = new AlphaFruitDecorator();
	public static com.mojang.serialization.Codec<AlphaFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alpha_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AlphaFruitDecorator() {
		super(0.2f);
	}
